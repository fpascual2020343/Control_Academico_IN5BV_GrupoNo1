                ...
                <div class="row">
                    <div class="col-12">
                        <h1 class="text-light text-center" style="background-color: #5E2129">
                            <i class="fab fa-delicious"></i></i> Salones <i class="fab fa-delicious"></i></i>
                        </h1>
                    </div>
                </div>
            </div>
                            ...
                            <tbody style="background-color: #000000">
                                <c:forEach var="Salon" items="${listadoSalon}"  > 
                                    <tr class="text-light">
                                        ...
                                        <td>
                                        <a style="background-color: #5e2129 " class="btn text-light " href="${pageContext.request.contextPath}/ServletSalon?accion=editar&salon_id=${Salon.salon_id}"><i class="far fa-edit"></i></i></a>
